...
require_once (dirname(__FILE__) . '/Model/CreateFulfillmentOrderItem.php');
require_once (dirname(__FILE__) . '/Model/CreateFulfillmentOrderItemList.php');
require_once (dirname(__FILE__) . '/Model/Currency.php');
require_once (dirname(__FILE__) . '/Interface.php');
